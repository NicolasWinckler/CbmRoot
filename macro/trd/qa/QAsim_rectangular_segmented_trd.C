...
void QAsim_rectangular_segmented_trd(Int_t nEvents = 2)
{
  ...
  TString trdGeom    = "trd/old/trd_rectangular_segmented.geo";
...
*/
  ...
  fRun->Run(nEvents);
  // ------------------------------------------------------------------------
  fRun->CreateGeometryFile("data/trd_rectangular_segmented_geometry.root");

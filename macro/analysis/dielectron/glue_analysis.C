...
//signal momentum distribution
    histList->Add( new TH1D("fh_mc_signal_mom", "fh_mc_signal_mom;momentum [GeV/c];yield",100, 0., 15.) );
    histList->Add( new TH1D("fh_acc_signal_mom","fh_acc_signal_mom;momentum [GeV/c];yield", 100, 0., 15.) );
    histList->Add( new TH1D("fh_sts_reco_signal_mom","fh_sts_reco_signal_mom;momentum [GeV/c];yield", 100, 0., 15.) );
    histList->Add( new TH1D("fh_rich_reco_signal_mom","fh_rich_reco_signal_mom;momentum [GeV/c];yield", 100, 0., 15.) );
    histList->Add( new TH1D("fh_reco_signal_mom","fh_reco_signal_mom;momentum [GeV/c];yield", 100, 0., 15.) );
    histList->Add( new TH1D("fh_chi_prim_signal_mom","fh_chi_prim_signal_mom;momentum [GeV/c];yield", 100, 0., 15.) );
    histList->Add( new TH1D("fh_rich_id_signal_mom","fh_rich_id_signal_mom;momentum [GeV/c];yield", 100, 0., 15.) );
...
//signal minv
	histList->Add( new TH1D("fh_mc_signal_minv","fh_mc_signal_minv;M_{ee} [GeV/c^{2}];yield",nofBinsMinv, 0., 2.) );
	histList->Add( new TH1D("fh_acc_signal_minv","fh_acc_signal_minv;M_{ee} [GeV/c^{2}];yield",nofBinsMinv, 0., 2.) );
	histList->Add( new TH1D("fh_rec_signal_minv","fh_rec_signal_minv;M_{ee} [GeV/c^{2}];yield",nofBinsMinv, 0., 2.) );
    histList->Add( new TH1D("fh_chi_prim_signal_minv","fh_chi_prim_signal_minv;M_{ee} [GeV/c^{2}];yield",nofBinsMinv, 0., 2.) );
	histList->Add( new TH1D("fh_rich_id_signal_minv","fh_rich_id_signal_minv;M_{ee} [GeV/c^{2}];yield", nofBinsMinv, 0., 2.) );
	histList->Add( new TH1D("fh_trd_id_signal_minv", "fh_trd_id_signal_minv;M_{ee} [GeV/c^{2}];yield", nofBinsMinv, 0., 2.) );
	histList->Add( new TH1D("fh_tof_id_signal_minv","fh_tof_id_signal_minv;M_{ee} [GeV/c^{2}];yield", nofBinsMinv, 0., 2.) );
	histList->Add( new TH1D("fh_gammacut_signal_minv","fh_gammacut_signal_minv;M_{ee} [GeV/c^{2}];yield",nofBinsMinv, 0., 2.) );
    histList->Add( new TH1D("fh_stcut_signal_minv","fh_stcut_signal_minv;M_{ee} [GeV/c^{2}];yield",nofBinsMinv, 0., 2.) );
	histList->Add( new TH1D("fh_ttcut_signal_minv","fh_ttcut_signal_minv;M_{ee} [GeV/c^{2}];yield",nofBinsMinv, 0., 2.) );
    histList->Add( new TH1D("fh_ptcut_signal_minv","fh_ptcut_signal_minv;M_{ee} [GeV/c^{2}];yield",nofBinsMinv, 0., 2.) );
    histList->Add( new TH1D("fh_anglecut_signal_minv","fh_anglecut_signal_minv;M_{ee} [GeV/c^{2}];yield",nofBinsMinv, 0., 2.) );
	histList->Add( new TH1D("fh_apmcut_signal_minv","fh_apmcut_signal_minv;M_{ee} [GeV/c^{2}];yield",nofBinsMinv, 0., 2.) );

//BG minv
	histList->Add( new TH1D("fh_rec_bg_minv","fh_rec_bg_minv;M_{ee} [GeV/c^{2}];yield", nofBinsMinv, 0., 2.) );
    histList->Add( new TH1D("fh_chi_prim_bg_minv","fh_chi_prim_bg_minv;M_{ee} [GeV/c^{2}];yield",nofBinsMinv, 0., 2.) );
	histList->Add( new TH1D("fh_rich_id_bg_minv","fh_rich_id_bg_minv;M_{ee} [GeV/c^{2}];yield", nofBinsMinv, 0., 2.) );
	histList->Add( new TH1D("fh_trd_id_bg_minv","fh_trd_id_bg_minv;M_{ee} [GeV/c^{2}];yield", nofBinsMinv, 0., 2.) );
	histList->Add( new TH1D("fh_tof_id_bg_minv","fh_tof_id_bg_minv;M_{ee} [GeV/c^{2}];yield", nofBinsMinv, 0., 2.) );
	histList->Add( new TH1D("fh_gammacut_bg_minv","fh_gammacut_bg_minv;M_{ee} [GeV/c^{2}];yield",nofBinsMinv, 0., 2.) );
    histList->Add( new TH1D("fh_stcut_bg_minv","fh_stcut_bg_minv;M_{ee} [GeV/c^{2}];yield",nofBinsMinv, 0., 2.) );
	histList->Add( new TH1D("fh_ttcut_bg_minv","fh_ttcut_bg_minv;M_{ee} [GeV/c^{2}];yield",nofBinsMinv, 0., 2.) );
    histList->Add( new TH1D("fh_ptcut_bg_minv","fh_ptcut_bg_minv;M_{ee} [GeV/c^{2}];yield",nofBinsMinv, 0., 2.) );
    histList->Add( new TH1D("fh_anglecut_bg_minv","fh_anglecut_bg_minv;M_{ee} [GeV/c^{2}];yield",nofBinsMinv, 0., 2.) );
	histList->Add( new TH1D("fh_apmcut_bg_minv","fh_apmcut_bg_minv;M_{ee} [GeV/c^{2}];yield",nofBinsMinv, 0., 2.) );

//pi0 minv
	histList->Add( new TH1D("fh_rec_pi0_minv","fh_rec_pi0_minv;M_{ee} [GeV/c^{2}];yield", nofBinsMinv, 0., 2.) );
    histList->Add( new TH1D("fh_chi_prim_pi0_minv","fh_chi_prim_pi0_minv;M_{ee} [GeV/c^{2}];yield",nofBinsMinv, 0., 2.) );
	histList->Add( new TH1D("fh_rich_id_pi0_minv","fh_rich_id_pi0_minv;M_{ee} [GeV/c^{2}];yield", nofBinsMinv, 0., 2.) );
	histList->Add( new TH1D("fh_trd_id_pi0_minv","fh_trd_id_pi0_minv;M_{ee} [GeV/c^{2}];yield", nofBinsMinv, 0., 2.) );
	histList->Add( new TH1D("fh_tof_id_pi0_minv","fh_tof_id_pi0_minv;M_{ee} [GeV/c^{2}];yield", nofBinsMinv, 0., 2.) );
	histList->Add( new TH1D("fh_gammacut_pi0_minv","fh_gammacut_pi0_minv;M_{ee} [GeV/c^{2}];yield",nofBinsMinv, 0., 2.) );
    histList->Add( new TH1D("fh_stcut_pi0_minv","fh_stcut_pi0_minv;M_{ee} [GeV/c^{2}];yield",nofBinsMinv, 0., 2.) );
	histList->Add( new TH1D("fh_ttcut_pi0_minv","fh_ttcut_pi0_minv;M_{ee} [GeV/c^{2}];yield",nofBinsMinv, 0., 2.) );
    histList->Add( new TH1D("fh_ptcut_pi0_minv","fh_ptcut_pi0_minv;M_{ee} [GeV/c^{2}];yield",nofBinsMinv, 0., 2.) );
    histList->Add( new TH1D("fh_anglecut_pi0_minv","fh_anglecut_pi0_minv;M_{ee} [GeV/c^{2}];yield",nofBinsMinv, 0., 2.) );
	histList->Add( new TH1D("fh_apmcut_pi0_minv","fh_apmcut_pi0_minv;M_{ee} [GeV/c^{2}];yield",nofBinsMinv, 0., 2.) );

//eta minv
	histList->Add( new TH1D("fh_rec_eta_minv","fh_rec_eta_minv;M_{ee} [GeV/c^{2}];yield", nofBinsMinv, 0., 2.) );
    histList->Add( new TH1D("fh_chi_prim_eta_minv","fh_chi_prim_eta_minv;M_{ee} [GeV/c^{2}];yield",nofBinsMinv, 0., 2.) );
	histList->Add( new TH1D("fh_rich_id_eta_minv","fh_rich_id_eta_minv;M_{ee} [GeV/c^{2}];yield", nofBinsMinv, 0., 2.) );
	histList->Add( new TH1D("fh_trd_id_eta_minv","fh_trd_id_eta_minv;M_{ee} [GeV/c^{2}];yield", nofBinsMinv, 0., 2.) );
	histList->Add( new TH1D("fh_tof_id_eta_minv","fh_tof_id_eta_minv;M_{ee} [GeV/c^{2}];yield", nofBinsMinv, 0., 2.) );
	histList->Add( new TH1D("fh_gammacut_eta_minv","fh_gammacut_eta_minv;M_{ee} [GeV/c^{2}];yield",nofBinsMinv, 0., 2.) );
    histList->Add( new TH1D("fh_stcut_eta_minv","fh_stcut_eta_minv;M_{ee} [GeV/c^{2}];yield",nofBinsMinv, 0., 2.) );
	histList->Add( new TH1D("fh_ttcut_eta_minv","fh_ttcut_eta_minv;M_{ee} [GeV/c^{2}];yield",nofBinsMinv, 0., 2.) );
    histList->Add( new TH1D("fh_ptcut_eta_minv","fh_ptcut_eta_minv;M_{ee} [GeV/c^{2}];yield",nofBinsMinv, 0., 2.) );
    histList->Add( new TH1D("fh_anglecut_eta_minv","fh_anglecut_eta_minv;M_{ee} [GeV/c^{2}];yield",nofBinsMinv, 0., 2.) );
	histList->Add( new TH1D("fh_apmcut_eta_minv","fh_apmcut_eta_minv;M_{ee} [GeV/c^{2}];yield",nofBinsMinv, 0., 2.) );
...
// cut distribution
	...
	histList->Add( new TH1D("fh_angle_bg","fh_angle_bg;opening angle [deg];yield", 360, 0., 180.) );
	...
	histList->Add( new TH1D("fh_pt_signal","fh_pt_signal;p_{t} [GeV/c];yield",200, 0., 2.) );
	histList->Add( new TH1D("fh_pt_bg","fh_pt_bg;p_{t} [GeV/c];yield",200, 0., 2.) );
	histList->Add( new TH1D("fh_mom_signal","fh_mom_signal;p [GeV/c];yield",200, 0., 10.) );
	histList->Add( new TH1D("fh_mom_bg","fh_mom_bg;p [GeV/c];yield",200, 0., 10.) );
	histList->Add( new TH1D("fh_chi2_prim_signal", "fh_chi2_prim_signal;chi2,yield", 200, 0., 20.) );
	histList->Add( new TH1D("fh_chi2_prim_bg","fh_chi2_prim_bg;chi2,yield", 200, 0., 20.) );
	histList->Add( new TH1D("fh_chi2sts_signal", "fh_chi2sts_signal;chi2,yield", 200, 0., 20.) );
	histList->Add( new TH1D("fh_chi2sts_bg","fh_chi2sts_bg;chi2,yield", 200, 0., 20.) );
    ...
    histList->Add( new TH2D("fh_dsts_signal","fh_dsts_signal;d_{MVD} [cm];p^{e} [GeV/c]", 100, 0., 1., 100, 0., 5.) );
    histList->Add( new TH2D("fh_dsts_bg", "fh_dsts_bg;d_{MVD} [cm];p^{e} [GeV/c]", 100, 0., 1., 100, 0., 5.) );
    histList->Add( new TH2D("fh_dsts_gamma","fh_dsts_gamma;d_{MVD} [cm];p^{e} [GeV/c]", 100, 0., 1., 100, 0., 5.) );
    histList->Add( new TH2D("fh_dsts_pi0","fh_dsts_pi0;d_{MVD} [cm];p^{e} [GeV/c]", 100, 0., 1., 100, 0., 5.) );

...
std::string qualityAnalysis::getAbsoluteQualityEFGCEventAnalysis() {
	...
	if(qualityEFGCEvent != NULL) {
		...
		if (qualityEFGCEventAbsolute) {
			...
			returnValue += "-------------------------------------------------";
			returnValue += "\n";		
			returnValue += "Event number of peaks according to tracks:       \t\t";
			uitos(qualityEFGCEvent->getPeakToTrackInfo()->numberOfIdentifiedPeaks, intBuffer, 10, intConversionDigits);
			returnValue += intBuffer;
			returnValue += "\n";		
			returnValue += "Event number of peaks according to clones:       \t\t";
			uitos(qualityEFGCEvent->getPeakToTrackInfo()->numberOfClonePeaks, intBuffer, 10, intConversionDigits);
			returnValue += intBuffer;
			returnValue += "\n";		
			returnValue += "Event number of peaks according to fakes:        \t\t";
			uitos(qualityEFGCEvent->getPeakToTrackInfo()->peakToFakeTrack, intBuffer, 10, intConversionDigits);
			returnValue += intBuffer;
			returnValue += "\n";		
			returnValue += "Event number of peaks according to ghosts:       \t\t";
			uitos(qualityEFGCEvent->getPeakToTrackInfo()->peakToNoTrack, intBuffer, 10, intConversionDigits);
			returnValue += intBuffer;
			returnValue += "\n";		
			returnValue += "Event number of peaks according to no track:     \t\t";
			...
			returnValue += "\n";		
			returnValue += "Event number of tracks according to no peak:     \t\t";
			uitos(qualityEFGCEvent->getTrackToPeakInfo()->trackToNoPeak, intBuffer, 10, intConversionDigits);
			returnValue += intBuffer;
			returnValue += "\n";		
			returnValue += "Event number of tracks according to one peak:    \t\t";
			uitos(qualityEFGCEvent->getTrackToPeakInfo()->trackToOnePeak, intBuffer, 10, intConversionDigits);
			returnValue += intBuffer;
			returnValue += "\n";		
			returnValue += "Event number of tracks according to more peaks:  \t\t";
			uitos(qualityEFGCEvent->getTrackToPeakInfo()->trackToMorePeaks, intBuffer, 10, intConversionDigits);
			returnValue += intBuffer;
			returnValue += "\n";		
			returnValue += "Event number of tracks which should be found:    \t\t";
			uitos(qualityEFGCEvent->getTrackToPeakInfo()->numberOfTracks, intBuffer, 10, intConversionDigits);
			returnValue += intBuffer;
			returnValue += "\n";		
			returnValue += "Event number of tracks which should not be found:\t\t";
			uitos(qualityEFGCEvent->getTrackToPeakInfo()->numberOfWrongFoundTracks, intBuffer, 10, intConversionDigits);
			returnValue += intBuffer;
			returnValue += "\n";		
			returnValue += "-------------------------------------------------";
			returnValue += "\n";		
			returnValue += "Event number of processed tracks:                \t\t";
			uitos(qualityEFGCEvent->getPeakToTrackInfo()->numberOfPeaks, intBuffer, 10, intConversionDigits);
			returnValue += intBuffer;
			returnValue += "\n";		
			returnValue += "Event number of fake tracks:                     \t\t";
			uitos(qualityEFGCEvent->getNumberOfFakeTracks(), intBuffer, 10, intConversionDigits);
			returnValue += intBuffer;
			returnValue += "\n";		
			returnValue += "Event number of ghost tracks:                    \t\t";
			uitos(qualityEFGCEvent->getNumberOfGhostTracks(), intBuffer, 10, intConversionDigits);
			returnValue += intBuffer;
			returnValue += "\n";		
			...
			returnValue += intBuffer;
			returnValue += "\n";		
			returnValue += "Event number of found tracks:                    \t\t";
			uitos(qualityEFGCEvent->getNumberOfIdentifiedTracks(), intBuffer, 10, intConversionDigits);
			returnValue += intBuffer;
			returnValue += "\n";		
			returnValue += "Event quality of trackfinding:                   \t\t";
			uitos(qualityEFGCEvent->getTrackQuality(), intBuffer, 10, intConversionDigits);
			returnValue += intBuffer;
			returnValue += "%";
			returnValue += "\n";		
			returnValue += "Event number of well found tracks:               \t\t";
			uitos(qualityEFGCEvent->getNumberOfWellFoundTracks(), intBuffer, 10, intConversionDigits);
			returnValue += intBuffer;
			returnValue += "\n";		
			returnValue += "Event quality of well trackfinding:              \t\t";
			uitos(qualityEFGCEvent->getWellTrackQuality(), intBuffer, 10, intConversionDigits);
			returnValue += intBuffer;
			returnValue += "%";
			returnValue += "\n";		
...
std::string qualityAnalysis::getAbsoluteQualityEFGCTotalAnalysis() {
	...
	if(qualityEFGCTotal != NULL) {
		...
		if (qualityEFGCTotalAbsolute) {
			...
			returnValue += "-------------------------------------------------";
			returnValue += "\n";		
			returnValue += "Total number of peaks according to tracks:       \t\t";
			uitos(qualityEFGCTotal->getPeakToTrackInfo()->numberOfIdentifiedPeaks, intBuffer, 10, intConversionDigits);
			returnValue += intBuffer;
			returnValue += "\n";		
			returnValue += "Total number of peaks according to clones:       \t\t";
			uitos(qualityEFGCTotal->getPeakToTrackInfo()->numberOfClonePeaks, intBuffer, 10, intConversionDigits);
			returnValue += intBuffer;
			returnValue += "\n";		
			returnValue += "Total number of peaks according to fakes:        \t\t";
			uitos(qualityEFGCTotal->getPeakToTrackInfo()->peakToFakeTrack, intBuffer, 10, intConversionDigits);
			returnValue += intBuffer;
			returnValue += "\n";		
			returnValue += "Total number of peaks according to ghosts:       \t\t";
			uitos(qualityEFGCTotal->getPeakToTrackInfo()->peakToNoTrack, intBuffer, 10, intConversionDigits);
			returnValue += intBuffer;
			returnValue += "\n";		
			returnValue += "Total number of peaks according to no track:     \t\t";
			...
			returnValue += "Track Summary";
			returnValue += "\n";		
			returnValue += "Total number of tracks according to no peak:     \t\t";
			uitos(qualityEFGCTotal->getTrackToPeakInfo()->trackToNoPeak, intBuffer, 10, intConversionDigits);
			returnValue += intBuffer;
			returnValue += "\n";		
			returnValue += "Total number of tracks according to one peak:    \t\t";
			uitos(qualityEFGCTotal->getTrackToPeakInfo()->trackToOnePeak, intBuffer, 10, intConversionDigits);
			returnValue += intBuffer;
			returnValue += "\n";		
			returnValue += "Total number of tracks according to more peaks:  \t\t";
			uitos(qualityEFGCTotal->getTrackToPeakInfo()->trackToMorePeaks, intBuffer, 10, intConversionDigits);
			returnValue += intBuffer;
			returnValue += "\n";		
			returnValue += "Total number of tracks which should be found:    \t\t";
			uitos(qualityEFGCTotal->getTrackToPeakInfo()->numberOfTracks, intBuffer, 10, intConversionDigits);
			returnValue += intBuffer;
			returnValue += "\n";		
			returnValue += "Total number of tracks which should not be found:\t\t";
			uitos(qualityEFGCTotal->getTrackToPeakInfo()->numberOfWrongFoundTracks, intBuffer, 10, intConversionDigits);
			returnValue += intBuffer;
			returnValue += "\n";		
			returnValue += "-------------------------------------------------";
			returnValue += "\n";		
			returnValue += "Total number of processed tracks:                \t\t";
			uitos(qualityEFGCTotal->getPeakToTrackInfo()->numberOfPeaks, intBuffer, 10, intConversionDigits);
			returnValue += intBuffer;
			returnValue += "\n";		
			returnValue += "Total number of fake tracks:                     \t\t";
			uitos(qualityEFGCTotal->getNumberOfFakeTracks(), intBuffer, 10, intConversionDigits);
			returnValue += intBuffer;
			returnValue += "\n";		
			returnValue += "Total number of ghost tracks:                    \t\t";
			uitos(qualityEFGCTotal->getNumberOfGhostTracks(), intBuffer, 10, intConversionDigits);
			returnValue += intBuffer;
			returnValue += "\n";		
			...
			returnValue += intBuffer;
			returnValue += "\n";		
			returnValue += "Total number of found tracks:                    \t\t";
			uitos(qualityEFGCTotal->getNumberOfIdentifiedTracks(), intBuffer, 10, intConversionDigits);
			returnValue += intBuffer;
			returnValue += "\n";		
			returnValue += "Total quality of trackfinding:                   \t\t";
			uitos(qualityEFGCTotal->getTrackQuality(), intBuffer, 10, intConversionDigits);
			returnValue += intBuffer;
			returnValue += "%";
			returnValue += "\n";		
			returnValue += "Total number of well found tracks:               \t\t";
			uitos(qualityEFGCTotal->getNumberOfWellFoundTracks(), intBuffer, 10, intConversionDigits);
			returnValue += intBuffer;
			returnValue += "\n";		
			returnValue += "Total quality of well trackfinding:              \t\t";
			uitos(qualityEFGCTotal->getWellTrackQuality(), intBuffer, 10, intConversionDigits);
			returnValue += intBuffer;
			returnValue += "%";
			returnValue += "\n";		

 ...
 **
 ** @file create_bpipe_geometry_v13e_rich.C
...
TString macrosname = "create_bpipe_geometry_v13e_rich.C";
// ---> Geometry file name (output)
TString rootFileName = "pipe4rich_v13e.root";
// ---> Geometry name
TString pipeName = "PIPE_v13e_rich";
// ----------------------------------------------------------------------------
...
void create_bpipe_geometry_v13e_rich()
{
  ...
  */ //for TEST
  ...
  Double_t rin04[nSects04]  = {    0.00001,      0.00001,     30.,     75.41,  102.26,  146.38,  183.6  }; // TODO - volume boolean operation correction
  ...
  infoFile << " thickness. The last three sections (and second window @ 6000mm) of beam " << endl;
  infoFile << " pipe (1800-7990mm) are rotated by an angle of " << Form("%.2f",rotangle) << " degrees relative to " << endl;
  infoFile << " point (0,0,1800) mm and the OY axis, following the bend of the ions in the " << endl;

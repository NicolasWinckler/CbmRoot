void sts_reco(TString dir = "data", Int_t fileNo=0, Int_t nEvents=10){
  TString mcFile      = dir + Form("/%02i/",fileNo) + "mc.root";
  TString parFile     = dir + Form("/%02i/",fileNo) + "mc.root";
  TString stsRecoFile = dir + Form("/%02i/",fileNo) + "sts.reco.root";

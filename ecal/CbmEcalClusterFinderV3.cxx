#include "CbmEcalClusterFinderV3.h"
...
/** Exec a task **/
void CbmEcalClusterFinderV3::Exec(Option_t* option)
{
  fEv++;
...
InitStatus CbmEcalClusterFinderV3::Init()
{
...
/** Finish a task **/
void CbmEcalClusterFinderV3::Finish()
{
  ;
}

/** Destructor **/
CbmEcalClusterFinderV3::~CbmEcalClusterFinderV3()
{
  if (fClusters)
  {
    fClusters->Delete();
...
void CbmEcalClusterFinderV3::FormPreClusters()
{
...
void CbmEcalClusterFinderV3::FormClusters()
{
...
void CbmEcalClusterFinderV3::ClearPreClusters()
{
...
CbmEcalClusterFinderV3::CbmEcalClusterFinderV3(const char* name, const Int_t verbose, const char* cfg)
...
ClassImp(CbmEcalClusterFinderV3)

...
void run_reco_shield(Int_t nfile = 1) {
  ...
  TString inFile = outDir + "shield" + numFile +".mc.10m.calo.root";
  TString parFile = outDir + "shield" + numFile +".param.10m.calo.root";
  //  TString outFile =  "shield" + numFile +".reco.10m.calo.root";
   TString outFile = outDir + "shield" + numFile +".reco.10m.calo.root";

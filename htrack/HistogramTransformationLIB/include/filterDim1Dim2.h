...
/// |     XXXX        |
/// |     X           |
/// |  XXXX           | 2 * { S[i=0;f1/2-1] (f2+1)/2 } + 1 = (f1/2)*(f2+1)+1
/// |  XXXX           |
/// ---------------------------------------------------------------------------------------------------
///
/// *******************************************************************
...
#ifndef _FILTERDIM1DIM2_H
#define _FILTERDIM1DIM2_H
...
/* **************************************************************
 * CLASS filterDim1Dim2		 									*
 * **************************************************************/

class filterDim1Dim2 : public filterDimXDimX {

 private:

  filterDim1Dim2(const filterDim1Dim2&);
  filterDim1Dim2& operator=(const filterDim1Dim2&);
 ...
 */
	...
	filterDim1Dim2( histogramData** histogram,

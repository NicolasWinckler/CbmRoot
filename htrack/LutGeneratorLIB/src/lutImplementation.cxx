...
void lutImplementation::generateRungeKuttaList(specialList<rungeKuttaListEntry, true, true, true, true, true>* rungeKuttaList, trackfinderInputDetector* detector, trackfinderInputMagneticField* magneticField, std::streambuf* terminal) {
...
void lutImplementation::generateRungeKuttaFileLuts(std::string prelutFileName, std::string prelutName, std::string lutFileName, std::string lutName, double dim3StartEntry, double dim3StopEntry, trackfinderInputDetector* detector, trackfinderInputMagneticField* magneticField, std::streambuf* terminal) {
	...
	generateRungeKuttaList(&rungeKuttaList, detector, magneticField, terminal);
...
void lutImplementation::initRungeKuttaFileLuts(double dim1Min, double dim1Max, int dim1Step, double dim2Min, double dim2Max, int dim2Step, double dim3Min, double dim3Max, int dim3Step, double dim3StartEntry, double dim3StopEntry, std::string prelutFileName, std::string lutFileName, trackfinderInputDetector* detector, trackfinderInputMagneticField* magneticField, std::streambuf* terminal) {

	allocateSpace(dim1Min, dim1Max, dim1Step, dim2Min, dim2Max, dim2Step, dim3Min, dim3Max, dim3Step);

	generateRungeKuttaFileLuts(prelutFileName, "Prelut generated by the Runge-Kutta approach", lutFileName, "Lut generated by the Runge-Kutta approach", dim3StartEntry, dim3StopEntry, detector, magneticField, terminal);

}
void lutImplementation::initRungeKuttaFileLuts(histogramSpace** space, double dim3StartEntry, double dim3StopEntry, std::string prelutFileName, std::string lutFileName, trackfinderInputDetector* detector, trackfinderInputMagneticField* magneticField, std::streambuf* terminal) {

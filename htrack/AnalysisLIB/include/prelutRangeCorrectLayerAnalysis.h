...
#ifndef _PRELUTRANGECORRECTLAYERANALYSIS_H
#define _PRELUTRANGECORRECTLAYERANALYSIS_H
...
class prelutRangeCorrectLayerAnalysis : public prelutRangeAnalysis {
 ...
 */
	...
	prelutRangeCorrectLayerAnalysis();
 ...
 */
	...
	prelutRangeCorrectLayerAnalysis(unsigned short numberOfDisplays);
	prelutRangeCorrectLayerAnalysis(unsigned short prelutRangeCut, unsigned int numberOfMinFactors, double factorMinMin, double factorMinMax, unsigned int numberOfMaxFactors, double factorMaxMin, double factorMaxMax);
	prelutRangeCorrectLayerAnalysis(unsigned short prelutRangeCut, unsigned short numberOfDisplays, unsigned int numberOfMinFactors, double factorMinMin, double factorMinMax, unsigned int numberOfMaxFactors, double factorMaxMin, double factorMaxMax);

/**
 * Destructor
 */

	virtual ~prelutRangeCorrectLayerAnalysis();

...
#ifndef _PROJECTIONEFGCNEVENT32ANALYSIS_H
#define _PROJECTIONEFGCNEVENT32ANALYSIS_H
...
/**
 * CLASS projectionEFGCNEvent32Analysis
 */

class projectionEFGCNEvent32Analysis : public projectionEFGCNAnalysis {
 ...
 */
	...
	projectionEFGCNEvent32Analysis();

/**
 * Destructor
 */

	virtual ~projectionEFGCNEvent32Analysis();

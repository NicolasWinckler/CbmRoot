 ...
 **
 ** @file create_bpipe_geometry_v13d.C
...
TString macrosname = "create_bpipe_geometry_v13d.C";
...
void create_bpipe_geometry_v13d()
{
  ...
  infoFile << " 6000mm with R800mm and 3mm thickness. The last section of beam pipe (6000-" << endl;
  infoFile << " 7990mm) is rotated by an angle of " << Form("%.2f",rotangle);
  infoFile << " degrees relative to point (0,0,1800)" << endl;
  infoFile << " mm and the OY axis, following the bend of the ions in the magnetic field" << endl;

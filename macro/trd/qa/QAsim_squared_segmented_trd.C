...
void QAsim_squared_segmented_trd(Int_t nEvents = 2)
{
  ...
  TString parFile = outDir + "/params_squared.root";
...
//  FairPrimaryGenerator* primGen = new FairPrimaryGenerator();
  ...
  fRun->Run(nEvents);
  // ------------------------------------------------------------------------
  fRun->CreateGeometryFile("data/trd_squared_segmented_geometry.root");

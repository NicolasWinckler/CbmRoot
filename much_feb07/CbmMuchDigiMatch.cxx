...
CbmMuchDigiMatch::CbmMuchDigiMatch(Int_t iPoint, UInt_t iCharge) {
  // Add point index
  if ( iPoint < 0 ) {
    cout << "-W- CbmMuchDigiMatch: Illegal MuchPoint index " 
	 << iPoint << endl;
  }
  else {
     fRefIndex.Set(0);
  ...
  // Add charge
  if ( iCharge < 0 ) {
    cout << "-W- CbmMuchDigiMatch: Illegal charge value " 
	 << iCharge << endl;
  }
  else {
     fCharge.Set(0);

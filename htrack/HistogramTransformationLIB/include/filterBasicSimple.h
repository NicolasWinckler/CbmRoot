...
/// ------------------------------------------------------------------------------------------------------------------
/// | filterBasicSimple      | delete array[element] if array[i] >= array[element]
/// ------------------------------------------------------------------------------------------------------------------
///
/// *******************************************************************
///
...
#ifndef _FILTERBASICSIMPLE_H
#define _FILTERBASICSIMPLE_H
...
class filterBasicSimple : public filterBasicStyle {

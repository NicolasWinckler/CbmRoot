...
#ifndef _PROJECTIONEFGCNEVENT12ANALYSIS_H
#define _PROJECTIONEFGCNEVENT12ANALYSIS_H
...
/**
 * CLASS projectionEFGCNEvent12Analysis
 */

class projectionEFGCNEvent12Analysis : public projectionEFGCNAnalysis {
 ...
 */
	...
	projectionEFGCNEvent12Analysis();

/**
 * Destructor
 */

	virtual ~projectionEFGCNEvent12Analysis();

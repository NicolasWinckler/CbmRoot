...
/// |        XXXX      |                                                                                                           |     XXX
/// |        XXXX      |                                                                                                           |     XXX
/// |        X inplace | (f3-1) * ( 2 * { S[i=0;f1/2-1] (f2+1)/2 } + 1) + 1 = (f3-1)*((f1/2)*(f2+1)+1)+1 different localFiltersize |     XXX
/// |     XXXX         |                                                                                                           |     XXX inplace
/// |     XXXX         |                                                                                                           |     XXX
/// -------------------------------------------------------------------------------------------------------------------------------------------------------------------
///
...
#ifndef _SECONDFILTERFINAL_H
#define _SECONDFILTERFINAL_H
...
/* **************************************************************
 * CLASS secondFilterFinal	 									*
 * **************************************************************/

class secondFilterFinal : public filterDimZDimZDimZ {
 ...
 */
	...
	secondFilterFinal( trackData**    tracks,

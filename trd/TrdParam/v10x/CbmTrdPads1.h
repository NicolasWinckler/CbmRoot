...
// v0.5
  ...
  Float_t fst1_pad_type[6][1][4] =      // array of pad sizes in station 1
    { { { 46., 46., .5, 46./23}, },     // 5 x  20    mm,  92 * 23 = 2116 pads mod1
      { { 46., 46., .5, 46./15}, },     // 5 x  30.67 mm,  92 * 15 = 1380 pads mod1
      { { 71., 71., .5, 71./20}, },     // 5 x  35.5  mm, 142 * 20 = 2840 pads mod2
      { { 71., 71., .5, 71./10}, },     // 5 x  71    mm, 142 * 10 = 1420 pads mod2
      { { 96., 96., .5, 96./10}, },     // 5 x  96    mm, 192 * 10 = 1920 pads mod3
      { { 96., 96., .5, 96./5 }, } };   // 5 x 192    mm, 192 *  5 =  960 pads mod3

  Int_t fst2_sect_count = 1;
  Float_t fst2_pad_type[6][1][4] =      // array of pad sizes in station 2
    { { { 46., 46., .5, 46./10}, },     // 5 x  46    mm,  92 * 10 =  920 pads mod1
      { { 46., 46., .5, 46./10}, },     // 5 x  46    mm,  92 * 10 =  920 pads mod1
      { { 71., 71., .5, 71./10}, },     // 5 x  71    mm, 142 * 10 = 1420 pads mod2
      { { 71., 71., .5, 71./7 }, },     // 5 x 101.4  mm, 142 *  7 =  994 pads mod2
      { { 96., 96., .5, 96./5 }, },     // 5 x 192    mm, 192 *  5 =  960 pads mod3
      { { 96., 96., .5, 96./5 }, } };   // 5 x 192    mm, 192 *  5 =  960 pads mod3

  Int_t fst3_sect_count = 1;
  Float_t fst3_pad_type[2][1][4] =      // array of pad sizes in station 3
    { { { 96., 96., .5, 96./10}, },     // 5 x  96    mm, 192 * 10 = 1920 pads mod3
      { { 96., 96., .5, 96./5 }, } };   // 5 x 192    mm, 192 *  5 =  960 pads mod3

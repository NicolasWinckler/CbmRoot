...
public:
  ...
  // }
   ...
   std::string ToString() const {
      return std::string("LitMaterialinfo:")
    		+ " Thickness=" + lit::parallel::ToString<T>(Thickness)
...
public:
   ...
   T Z; // Atomic number
   T A; // Atomic mass
//   T RadThick; // Thickness/X0
//   T SqrtRadThick; // std::sqrt(Thickness/X0)
//   T LogRadThick; // std::log(Thickness/X0)

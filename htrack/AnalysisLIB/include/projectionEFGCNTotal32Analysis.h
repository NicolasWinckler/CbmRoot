...
///
/// $Author: csteinle $
/// $Date: 2006/11/17 15:12:26 $
/// $Revision: 1.1 $
///
//////////////////////////////////////////////////////////////////////


#ifndef _PROJECTIONEFGCNTOTAL32ANALYSIS_H
#define _PROJECTIONEFGCNTOTAL32ANALYSIS_H
...
/**
 * CLASS projectionEFGCNTotal32Analysis
 */

class projectionEFGCNTotal32Analysis : public projectionEFGCNAnalysis {
 ...
 */
	...
	projectionEFGCNTotal32Analysis();

/**
 * Destructor
 */

	virtual ~projectionEFGCNTotal32Analysis();

...
//         (first_time_Module3 && ( module_number == 3 ))) {
	...
	//        fprintf(geofile,"trd%dmod%dpad%d#%d%03d\n",Station_number, module_number, 1, Layer_number+1, copy_number);
...
// feb#1
      fprintf(geofile,"//*********************************\n");
      fprintf(geofile,"trd%dmod%dfeb#%d\n",Station_number, module_number, 1);
      fprintf(geofile,"trd%dmod%dfee\n",Station_number, module_number);

      fprintf(geofile,"BOX\n");
      fprintf(geofile,"polypropylene\n");
      fprintf(geofile,"%f %f %f\n", Active_area_y[j] ,-feb_thickness /2 , -fee_thickness/2);
      fprintf(geofile,"%f %f %f\n", Active_area_y[j] , feb_thickness /2 , -fee_thickness/2);
      fprintf(geofile,"%f %f %f\n",-Active_area_y[j] , feb_thickness /2 , -fee_thickness/2);
      fprintf(geofile,"%f %f %f\n",-Active_area_y[j] ,-feb_thickness /2 , -fee_thickness/2);
      fprintf(geofile,"%f %f %f\n", Active_area_y[j] ,-feb_thickness /2 ,  fee_thickness/2);
...
// feb#2
      fprintf(geofile,"//*********************************\n");
      fprintf(geofile,"trd%dmod%dfeb#%d\n",Station_number, module_number, 2);
      fprintf(geofile,"trd%dmod%dfee\n",Station_number, module_number);
...
// feb#3
      fprintf(geofile,"//*********************************\n");
      fprintf(geofile,"trd%dmod%dfeb#%d\n",Station_number, module_number, 3);
      fprintf(geofile,"trd%dmod%dfee\n",Station_number, module_number);
...
// feb#4
      fprintf(geofile,"//*********************************\n");
      fprintf(geofile,"trd%dmod%dfeb#%d\n",Station_number, module_number, 4);
      fprintf(geofile,"trd%dmod%dfee\n",Station_number, module_number);
...
// feb#5
      fprintf(geofile,"//*********************************\n");
      fprintf(geofile,"trd%dmod%dfeb#%d\n",Station_number, module_number, 5);
      fprintf(geofile,"trd%dmod%dfee\n",Station_number, module_number);
...
int main(void)
{
 ...
 //-----------Files------------------------------------------------
  ...
  string geoname  = path + "trd_may11_v11a_feb.geo" ; // test
  string infoname = path + "trd_may11_v11a_feb.geo.info";

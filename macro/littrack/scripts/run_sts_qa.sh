...
xterm -hold -e ". ./sts_qa.sh sts_v12b sts/sts_v12b.geo.root $VMCWORKDIR/parameters/sts/sts_v12b_std.digi.par ${VMCWORKDIR}/parameters/sts/sts_matbudget_v12b.root"&

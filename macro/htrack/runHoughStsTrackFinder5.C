...

{
  ...
  TString inFile       = inputFolder  + "/" + system + "." + beam + "." + trigger + ".mc.5.root";

  // Output file
  TString outFile      = outputFolder + "/" + system + "." + beam + "." + trigger + ".reco.5.root";

  // Parameter file
  TString parFile      = inputFolder  + "/" + system + "." + beam + "." + trigger + ".params.5.root";

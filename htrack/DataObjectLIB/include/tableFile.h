...
#define numberOfTableFileCmds 3			/**< Definition of the number of parameters gettable from file. */
 ...
 */
	...
	tableFileHeader& getHeaderReference();

/**
 * This method sets the data struct	to the existing one.
 */

	void setHeader(tableFileHeader& structure);

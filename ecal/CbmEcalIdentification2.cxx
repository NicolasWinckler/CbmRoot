#include "CbmEcalIdentification2.h"
...
/** Loop procedure **/
void CbmEcalIdentification2::Exec(Option_t* option)
{
  fEvent++;
...
/** Identify a track **/
void CbmEcalIdentification2::Identify(FairTrackParam* tr)
{
...
void CbmEcalIdentification2::WriteTree()
{
  fPDG=-1111;
  fMCPDG=-1111;
  fMotherMCPDG=-1111;
...
Double_t CbmEcalIdentification2::GetEnergy(CbmEcalCell* cell)
{
  if (fUseHack==0)
...
/** Get energy in PS  **/
Double_t CbmEcalIdentification2::GetPSEnergy(CbmEcalCell* cell)
{
  if (fUseHack==0)
...
/** Initializes tree **/
void CbmEcalIdentification2::InitTree()
{
  if (fTree) return;
...
/** Initializes tree **/
void CbmEcalIdentification2::InitVar()
{
  fCellX=-1111;
  fCellY=-1111;
  fMaxX=-1111;
...
CbmEcalIdentification2::CbmEcalIdentification2(const char* name, const Int_t iVerbose, const char* config)
...
/** Initing routine **/
InitStatus CbmEcalIdentification2::Init()
{
  Int_t f;
  Int_t r;
  TString nm;
...
/** Finishing routine **/
void CbmEcalIdentification2::Finish()
{
...
Double_t CbmEcalIdentification2::GetPL(Double_t e, Double_t theta) const
{
...
Double_t CbmEcalIdentification2::GetPH(Double_t e, Double_t theta) const
{
...
Int_t CbmEcalIdentification2::CheckMaximum(CbmEcalMaximum* max)
{
  Double_t trpl;
  Double_t trph;
  Double_t trdp;
...
void CbmEcalIdentification2::ConstructCluster(CbmEcalMaximum* max)
{
  Int_t i;
  Int_t j;
  list<CbmEcalCell*> cells;
...
Double_t CbmEcalIdentification2::SolveEllipse(CbmEcalCell* cell, Double_t cx, Double_t cy, Int_t reg)
{
...
void CbmEcalIdentification2::ShapeAnalysis(CbmEcalMaximum* max)
{
  if (!fTreeOut) return;
...
ClassImp(CbmEcalIdentification2)

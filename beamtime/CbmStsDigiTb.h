 ...
 ** Data level: RAW
 ** For use in testbeam data DEC13
 **
 ...
 ** Time (ns):                     14 bits
 **
 ** The time is the absolute time.
 **
 **/


#ifndef CBMSTSDIGITB_H
#define CBMSTSDIGITB_H 1


#include "CbmDetectorList.h"
#include "CbmDigi.h"
#include "sts/CbmStsDetectorId.h"

#include <vector>

class CbmStsDigiTb : public CbmDigi, public CbmStsDetectorId
{
...
// 	     Int_t channel, Int_t adc, Int_t time);
  CbmStsDigiTb(Int_t station, Int_t sector, Int_t side,
	     Int_t channel, Int_t adc, ULong_t time);


  /**   Destructor   **/
  virtual ~CbmStsDigiTb();

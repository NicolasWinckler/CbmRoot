...
void CbmModule::ConstructGDMLGeometry(TGeoMatrix* posrot)
{
  fLogger->Error(MESSAGE_ORIGIN," Could not construct magnet geometry from gdml file. ");
  fLogger->Error(MESSAGE_ORIGIN," The used ROOT version does not support gdml. ");
  fLogger->Error(MESSAGE_ORIGIN," Please recompile ROOT with gdml support. ");
  fLogger->Fatal(MESSAGE_ORIGIN," Stop execution at this point. ");
}

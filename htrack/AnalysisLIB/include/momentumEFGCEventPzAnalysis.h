...
#ifndef _MOMENTUMEFGCEVENTPZANALYSIS_H
#define _MOMENTUMEFGCEVENTPZANALYSIS_H
...
/* **************************************************************
 * CLASS momentumEFGCEventPzAnalysis				 			*
 * **************************************************************/

class momentumEFGCEventPzAnalysis : public momentumEFGCAnalysis {
 ...
 */
	...
	virtual ~momentumEFGCEventPzAnalysis();

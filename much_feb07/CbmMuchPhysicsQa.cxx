...
//-------------- statistics: names of files, parameters of tracks, ID of particles etc.  
  ...
  sprintf(tt,"#mu #topbar  %3.3f", fNofMu*scale);
  tex1->DrawLatex(0.65,0.7,tt);
  sprintf(tt,"#pi #topbar  %3.3f", fNofPi*scale);
  tex1->DrawLatex(0.65,0.6,tt);
  sprintf(tt,"K #topbar %3.3f", fNofK*scale);
  tex1->DrawLatex(0.65,0.5,tt);
  sprintf(tt,"p  #topbar %3.3f", fNofP*scale);
  ...
  if(fQaType == 1)
  {
   ...
   sprintf(tt,"#mu #topbar  %3.3f", fNofMuMuch*scale);
   tex1->DrawLatex(0.8,0.7,tt);
   sprintf(tt,"#pi #topbar  %3.3f", fNofPiMuch*scale);
   tex1->DrawLatex(0.8,0.6,tt);
   sprintf(tt,"K #topbar %3.3f", fNofKMuch*scale);
   tex1->DrawLatex(0.8,0.5,tt);
   sprintf(tt,"p  #topbar %3.3f", fNofPMuch*scale);
   tex1->DrawLatex(0.8,0.4,tt);  
   sprintf(tt,"e  #topbar %3.3f", fNofEMuch*scale);

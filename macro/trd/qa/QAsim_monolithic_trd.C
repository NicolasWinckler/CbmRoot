...
void QAsim_monolithic_trd(Int_t nEvents = 2)
{
  ...
  TString outDir  = "data";
  TString outFile = outDir + "/trd_monolithic.mc.root";
  TString parFile = outDir + "/params_monolithic.root";
  ...
  TString trdGeom    = "trd/old/trd_monolithic.geo";

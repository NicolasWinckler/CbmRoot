...
namespace roc {
  ...
  enum ClientRole { roleNone,               //!< no defined role
   ...
   //! value of subevent iProc in mbs event.
   /*!
    * For raw data rocid stored in iSubcrate, for merged data iSubcrate 
    * stores higher bits.
    */
   enum ERocMbsTypes {
...
\endverbatim
         ...
         */
         ...
         //! Return backend kinds - kind_Optic (1), kind_FX20 (2) or kind_FX40 (3)

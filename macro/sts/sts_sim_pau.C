...
//  TString parFile = Form("params.25gev.1000.root",nEvents);
  ...
  sprintf(strInputFile, "/Users/Anna/cbmroot/input/pau/urqmd.pau.%1.0fgev.centr.%4d",
	  energy, index);
  sprintf(strParamFile, "params.pau.%1.0fgev.centr.%4d.root",
	  energy, index);
  sprintf(strOutputFile, "sts.mc.pau.%1.0fgev.centr.%4d.root",
	  energy, index);

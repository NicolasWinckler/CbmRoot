...
#ifndef _MAGNETFIELDXANALYSIS_H
#define _MAGNETFIELDXANALYSIS_H
...
/**
 * CLASS magnetfieldXAnalysis
 */

class magnetfieldXAnalysis : public magnetfieldDirectionAnalysis {

...
#ifndef _PROJECTIONEFGCNTOTAL12ANALYSIS_H
#define _PROJECTIONEFGCNTOTAL12ANALYSIS_H
...
/**
 * CLASS projectionEFGCNTotal12Analysis
 */

class projectionEFGCNTotal12Analysis : public projectionEFGCNAnalysis {
 ...
 */
	...
	projectionEFGCNTotal12Analysis();

/**
 * Destructor
 */

	virtual ~projectionEFGCNTotal12Analysis();

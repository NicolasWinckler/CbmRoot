...
///
/// $Author: csteinle $
/// $Date: 2006/11/17 15:12:25 $
/// $Revision: 1.1 $
///
//////////////////////////////////////////////////////////////////////


#ifndef _PROJECTIONEFGCNEVENT13ANALYSIS_H
#define _PROJECTIONEFGCNEVENT13ANALYSIS_H
...
/**
 * CLASS projectionEFGCNEvent13Analysis
 */

class projectionEFGCNEvent13Analysis : public projectionEFGCNAnalysis {
 ...
 */
	...
	projectionEFGCNEvent13Analysis();

/**
 * Destructor
 */

	virtual ~projectionEFGCNEvent13Analysis();

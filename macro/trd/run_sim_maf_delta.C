...
void run_sim_maf_delta(Int_t nEvents = 1, Int_t urqmd = 0000, TString centrality = "mbias")
{
  ...
  // -----   Add Delta Electrons   ------------------------------------------
  FairIonGenerator *AuGen = new FairIonGenerator(79, 197, 79, 1, 0., 0., 25, 0., 0., -0.1);

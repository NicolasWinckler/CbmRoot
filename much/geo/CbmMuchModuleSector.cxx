...
void CbmMuchModuleSector::AddSector(CbmMuchSector* sector) {
  fSectors.Add(sector);
}
// -------------------------------------------------------------------------
...
CbmMuchSector* CbmMuchModuleSector::GetSector(Long64_t channelId) {
...
// -----   Public method GetSector   ---------------------------------------
CbmMuchSector* CbmMuchModuleSector::GetSector(Int_t iGridColumn, Int_t iGridRow) {
...
// -----   Public method GetSector   ---------------------------------------
CbmMuchSector* CbmMuchModuleSector::GetSector(Double_t x, Double_t y){
...
Double_t CbmMuchModuleSector::GetGridCellX(Int_t iCol){
  Int_t nX;
  if(fUseModuleDesign){
...
Double_t CbmMuchModuleSector::GetGridCellY(Int_t iRow){
  Int_t nY;
  if(fUseModuleDesign){
...
Double_t CbmMuchModuleSector::GetInitX(CbmMuchSector* sector){
  Int_t nX;
...
Double_t CbmMuchModuleSector::GetInitY(CbmMuchSector* sector){
  Int_t nY;
...
Bool_t CbmMuchModuleSector::InitGrid(Bool_t useModuleDesign) {
...
void CbmMuchModuleSector::InitNeighbourSectors() {
  for (Int_t iSector = 0; iSector < GetNSectors(); iSector++) {
    CbmMuchSector* sector = GetSector(iSector);
    if (!sector) continue;
...
void CbmMuchModuleSector::InitNeighbourPads() {

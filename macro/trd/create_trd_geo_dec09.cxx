...
//  Distance[2]          = 9500;
  ...
  //------------------------------------------------------------------
  float x101 = Detector_size_x[0] *  0;
  float y101 = Detector_size_y[0] *  1;

  float x102 = Detector_size_x[0] *  1;
  float y102 = Detector_size_y[0] *  1;

  float x103 = Detector_size_x[0] *  1;
  float y103 = Detector_size_y[0] *  0;

  float x104 = Detector_size_x[0] *  1;
  float y104 = Detector_size_y[0] * -1;
  ...
  //------------------------------------------------------------------
  float x201 = Detector_size_x[1] * -0.5;
  float y201 = Detector_size_y[1] *  1.5;

  float x202 = Detector_size_x[1] *  0.5;
  float y202 = Detector_size_y[1] *  1.5;

  float x203 = Detector_size_x[1] *  1.5;
  float y203 = Detector_size_y[1] *  1.5;

  float x204 = Detector_size_x[1] *  1.5;
  float y204 = Detector_size_y[1] *  0.5;

  float x205 = Detector_size_x[1] *  1.5;
  float y205 = Detector_size_y[1] * -0.5;

  float x206 = Detector_size_x[1] *  1.5;
  ...
  float x301 = Detector_size_x[2] * -1;
  float y301 = Detector_size_y[2] *  2;

  float x302 = Detector_size_x[2] *  0;
  float y302 = Detector_size_y[2] *  2;

  float x303 = Detector_size_x[2] *  1;
  float y303 = Detector_size_y[2] *  2;

  float x304 = Detector_size_x[2] *  2;
  float y304 = Detector_size_y[2] *  2;

  float x305 = Detector_size_x[2] *  3;
  float y305 = Detector_size_y[2] *  2;

  float x306 = Detector_size_x[2] *  4;
  float y306 = Detector_size_y[2] *  2;

  float x307 = Detector_size_x[2] *  2;
  float y307 = Detector_size_y[2] *  1;

  float x308 = Detector_size_x[2] *  3;
  float y308 = Detector_size_y[2] *  1;

  float x309 = Detector_size_x[2] *  4;
  float y309 = Detector_size_y[2] *  1;

  float x310 = Detector_size_x[2] *  2;
  float y310 = Detector_size_y[2] *  0;

  float x311 = Detector_size_x[2] *  3;
  float y311 = Detector_size_y[2] *  0;

  float x312 = Detector_size_x[2] *  4;
  float y312 = Detector_size_y[2] *  0;

  float x313 = Detector_size_x[2] *  2;
  float y313 = Detector_size_y[2] * -1;

  float x314 = Detector_size_x[2] *  3;
  float y314 = Detector_size_y[2] * -1;

  float x315 = Detector_size_x[2] *  4;
  float y315 = Detector_size_y[2] * -1;

  float x316 = Detector_size_x[2] *  2;
  ...
  float y318 = Detector_size_y[2] * -2;
...
//
  ...
  float station3[11][2] = { {-1, 1}, {-5, 5}, {-7, 7}, {-7, 7}, {-7, 7},
                            {-7, 7},
	   		    {-7, 7}, {-7, 7}, {-7, 7}, {-5, 5}, {-1, 1} }; 

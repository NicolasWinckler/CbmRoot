...
const myf MINIMUM_PROPAGATION_DISTANCE = 1e-5; // minimum propagation distance [cm]
const myf MAXIMUM_TGEO_NAVIGATION_DISTANCE = 20.; // maximum distance used in the TGeo navigation

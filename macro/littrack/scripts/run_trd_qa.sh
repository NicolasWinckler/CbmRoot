...
xterm -hold -e ". ./trd_qa.sh trd_v13g trd/trd_v13g.geo.root $VMCWORKDIR/parameters/trd/trd_v13g.digi.par 6 25gev"&
xterm -hold -e ". ./trd_qa.sh trd_v13k trd/trd_v13k.geo.root $VMCWORKDIR/parameters/trd/trd_v13k.digi.par 6 8gev"&

#xterm -hold -e ". ./trd_qa.sh trd_v13c trd/trd_v13c.root $VMCWORKDIR/parameters/trd/trd_v13c.digi.par 6 25gev"&
#xterm -hold -e ". ./trd_qa.sh trd_v13d trd/trd_v13d.root $VMCWORKDIR/parameters/trd/trd_v13d.digi.par 1 8gev"&
#xterm -hold -e ". ./trd_qa.sh trd_v13e trd/trd_v13e.root $VMCWORKDIR/parameters/trd/trd_v13e.digi.par 1 8gev"&
#xterm -hold -e ". ./trd_qa.sh trd_v13f trd/trd_v13f.root $VMCWORKDIR/parameters/trd/trd_v13f.digi.par 1 8gev"&

#xterm -hold -e ". ./trd_qa.sh trd_v13s trd/trd_v13s.root $VMCWORKDIR/parameters/trd/trd_v13s.digi.par 1 8gev"&
#xterm -hold -e ". ./trd_qa.sh trd_v13t trd/trd_v13t.root $VMCWORKDIR/parameters/trd/trd_v13t.digi.par 1 8gev"&
...
#xterm -hold -e ". ./trd_qa.sh trd_v12alc trd/trd_v12alc.root $VMCWORKDIR/parameters/trd/trd_v12a.digi.par"&
#xterm -hold -e ". ./trd_qa.sh trd_v12ald trd/trd_v12ald.root $VMCWORKDIR/parameters/trd/trd_v12a.digi.par"&
#xterm -hold -e ". ./trd_qa.sh trd_v12ale trd/trd_v12ale.root $VMCWORKDIR/parameters/trd/trd_v12a.digi.par"&
#xterm -hold -e ". ./trd_qa.sh trd_v12alf trd/trd_v12alf.root $VMCWORKDIR/parameters/trd/trd_v12a.digi.par"&
#xterm -hold -e ". ./trd_qa.sh trd_v12alg trd/trd_v12alg.root $VMCWORKDIR/parameters/trd/trd_v12a.digi.par"&
#xterm -hold -e ". ./trd_qa.sh trd_v12alh trd/trd_v12alh.root $VMCWORKDIR/parameters/trd/trd_v12a.digi.par"&

# 3x3x2
#xterm -hold -e ". ./trd_qa.sh trd_v12ali trd/trd_v12ali.root $VMCWORKDIR/parameters/trd/trd_v12a.digi.par"&
#xterm -hold -e ". ./trd_qa.sh trd_v12alj trd/trd_v12alj.root $VMCWORKDIR/parameters/trd/trd_v12a.digi.par"&
#xterm -hold -e ". ./trd_qa.sh trd_v12alk trd/trd_v12alk.root $VMCWORKDIR/parameters/trd/trd_v12a.digi.par"&
#xterm -hold -e ". ./trd_qa.sh trd_v12all trd/trd_v12all.root $VMCWORKDIR/parameters/trd/trd_v12a.digi.par"&
#xterm -hold -e ". ./trd_qa.sh trd_v12alm trd/trd_v12alm.root $VMCWORKDIR/parameters/trd/trd_v12a.digi.par"&
#xterm -hold -e ". ./trd_qa.sh trd_v12aln trd/trd_v12aln.root $VMCWORKDIR/parameters/trd/trd_v12a.digi.par"&
#xterm -hold -e ". ./trd_qa.sh trd_v12alo trd/trd_v12alo.root $VMCWORKDIR/parameters/trd/trd_v12a.digi.par"&

# 2x2x2
#xterm -hold -e ". ./trd_qa.sh trd_v12alp trd/trd_v12alp.root $VMCWORKDIR/parameters/trd/trd_v12a.digi.par"&
#xterm -hold -e ". ./trd_qa.sh trd_v12alq trd/trd_v12alq.root $VMCWORKDIR/parameters/trd/trd_v12a.digi.par"&
#xterm -hold -e ". ./trd_qa.sh trd_v12alr trd/trd_v12alr.root $VMCWORKDIR/parameters/trd/trd_v12a.digi.par"&
#xterm -hold -e ". ./trd_qa.sh trd_v12als trd/trd_v12als.root $VMCWORKDIR/parameters/trd/trd_v12a.digi.par"&
#xterm -hold -e ". ./trd_qa.sh trd_v12alt trd/trd_v12alt.root $VMCWORKDIR/parameters/trd/trd_v12a.digi.par"&
#xterm -hold -e ". ./trd_qa.sh trd_v12alu trd/trd_v12alu.root $VMCWORKDIR/parameters/trd/trd_v12a.digi.par"&

...
void run_reco(Int_t nEvents = 500)
{
  ...
  // ========================================================================
   // ----- Paths and file names  --------------------------------------------
	TString outFile = "/d/cbm02/slebedev/rich/ellipse_qa/auau.25gev.centr.0000.reco.root";
	TString inFile = "/d/cbm02/slebedev/rich/ellipse_qa/auau.25gev.centr.0000.mc.root";
	TString parFile = "/d/cbm02/slebedev/rich/ellipse_qa/params.0000.root";
...
//  gSystem->Load("libEcal");
 ...
 // ((CbmL1TrdTrackFinderSts*)trdTrackFinder)->SetVerbose(iVerbose);
  ...
  //CbmRichRingQa* richQa   =  new CbmRichRingQa("Qa","qa", 0,0);
  //run->AddTask(richQa);
  // ------------------------------------------------------------------------

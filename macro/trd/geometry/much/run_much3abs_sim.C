...
void run_much3abs_sim(TString inputSignal = "",
                      TString inputBgr = "",
                      TString outFile = "",
                      Int_t nEvents = 1)
{
  ...
  TString pipeGeom   = "../macro/trd/geometry/much/pipe_much_short.geo";
  TString shieldGeom = "../macro/trd/geometry/much/shield_standard_trd_v13l.geo";
  ...
  TString muchGeom   = "../macro/trd/geometry/much/much_v13b.geo";
  TString trdGeom    = "trd/trd_v13l.root";
...
//  FairPrimaryGenerator* primGen = new FairPrimaryGenerator();
  ...
  fRun->Run(nEvents);
  // Write geometry
  fRun->CreateGeometryFile("much3_geometry.root");
  // ------------------------------------------------------------------------

...
#ifndef _MAGNETFIELDZANALYSIS_H
#define _MAGNETFIELDZANALYSIS_H
...
/**
 * CLASS magnetfieldZAnalysis
 */

class magnetfieldZAnalysis : public magnetfieldDirectionAnalysis {

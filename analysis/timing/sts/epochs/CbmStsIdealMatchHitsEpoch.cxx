...
#include "CbmStsHit.h"
#include "CbmStsIdealMatchHitsEpoch.h"
...
// -----   Default constructor   -------------------------------------------
CbmStsIdealMatchHitsEpoch::CbmStsIdealMatchHitsEpoch() 
...
CbmStsIdealMatchHitsEpoch::CbmStsIdealMatchHitsEpoch(Int_t iVerbose)
...
CbmStsIdealMatchHitsEpoch::CbmStsIdealMatchHitsEpoch(const char* name, Int_t iVerbose)
      ...
      for ( Int_t jMatchF=0; jMatchF<3; jMatchF++) {
        ...
        for ( Int_t jMatchB=0; jMatchB<3; jMatchB++) {
          ...
          Double_t dist = TMath::Sqrt( (xP-xH)*(xP-xH) + 
                                       (yP-yH)*(yP-yH) );
          // exclude points which are separated from the hit in time
          if (TMath::Abs(point->GetTime()-hit->GetTimeStamp())>10) continue;
          fCandMap[dist] = iPointF;
        }   // back digi loop
      }     // front digi loop
    }       // strip sensor
...
void CbmStsIdealMatchHitsEpoch::SetParContainers() {
...
// -----   Private method Init   -------------------------------------------
InitStatus CbmStsIdealMatchHitsEpoch::Init() {
...
InitStatus CbmStsIdealMatchHitsEpoch::ReInit() {
...
void CbmStsIdealMatchHitsEpoch::Finish() {
...
ClassImp(CbmStsIdealMatchHitsEpoch)

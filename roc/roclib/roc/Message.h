...
namespace roc {
   ...
   class Message {
      ...
      public:
         ...
         //! For Epoch2 data: Returns the epoch number (20 bit field)
         ...
         inline uint32_t getEpoch2ChipNumber() const { return getField(32, 8); }
         ...
         inline void setEpoch2Number(uint32_t v) { setField(12, 20, v); }

         //! For Epoch2 data: Set the number of the GET4 chip that send
			//! the epoche message (8 bit field)
         inline void setEpoch2ChipNumber(uint32_t v) { setField(32, 8, v); }
         ...
         //! For Get4 data: Returns Get4 time stamp (20 bit field)
         ...
         //! For Get4 data: Sets Get4 time stamp (20 bit field)
         ...
         //! Expanded timestamp for 250/8*5 MHz * 20 bit epochs
         inline static uint64_t FullTimeStamp2(uint32_t epoch, uint32_t stamp)
            { return ((uint64_t) epoch << 20) | (stamp & 0xfffff); }

...
#ifndef _TRACKPROPAGATIONEVENTPOINTANALYSIS_H
#define _TRACKPROPAGATIONEVENTPOINTANALYSIS_H
...
/* **************************************************************
 * CLASS trackPropagationEventPointAnalysis			 			*
 * **************************************************************/

class trackPropagationEventPointAnalysis : public trackPropagationDAnalysis {
 ...
 */
	...
	virtual ~trackPropagationEventPointAnalysis();
